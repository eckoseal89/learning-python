...
# 3. Declara una variable booleana is_student que indique si eres estudiante o no. Usa True o False segÃºn corresponda
    e imprÃ­mela.

# 4. Usa la funciÃ³n len() para calcular cuÃ¡ntos caracteres tiene tu nombre completo, almacenado en una variable.
# 5. Declara tres variables en una sola lÃ­nea que representen tu nombre, apellido y ciudad de origen. Luego, imprime
estos valores.

# 6. Usa la funciÃ³n input() para solicitar al usuario su color favorito y almacÃ©nalo en una variable color.
Luego, imprime el valor ingresado.

# 7. Declara una variable fruit e inicialÃ­zala con un valor. Luego, cambia el valor de la fruta a otro diferente
...
# 9. Declara una variable llamada address_len y almacena en ella la cantidad de caracteres de una direcciÃ³n usando
la funciÃ³n len(). Imprime el resultado.
...
name, age, height = "David", 35, 1.72

print(f"{name}\n{age}\n{height}")

print(len(name))

nombre, apellido, ciudad = "David", "Tena", "Ferrol"
print(f"{nombre}\n{apellido}\n{ciudad}")
...
address_len = len("Calle Julio Atienza Berrocal")
print(address_len)
